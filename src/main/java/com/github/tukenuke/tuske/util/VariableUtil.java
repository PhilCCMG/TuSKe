...
public class VariableUtil {
	...
	public Map<Class, Object> map = ReflectionUtils.getField(Variables.class, null, "localVariables");
	/**
	...
	public Object copyVariables(Event from){
		if (from != null && map.containsKey(from.getClass())) {
			Object variablesMap = map.get(from.getClass());
